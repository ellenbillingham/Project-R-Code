...
outg <- optim(c(1.375, 0.01*var(Y)), nl, gradnl, method="L-BFGS-B", 
              lower=eps, upper=c(2.5, var(Y)), D=D, Y=Y)
...
matplot(XX, t(YY), type="l", lty=1, col="gray", xlab=expression(beta), ylab="Maximum proportion of population infected")
